...
# suport for custom post types using Custom Post Type UI plugin
function cptui_register_my_cpts() {
	...
	$args = array(
		...
		"map_meta_cap" => true,
		"hierarchical" => false,
		"rewrite" => array( "slug" => "case_studies", "with_front" => true ),
		"query_var" => true,
...
function calculateCompanyAge() {
	$yearFounded = 1997;
	$currentYear = date("Y");
	$companyAge = $currentYear - $yearFounded;
	return $companyAge;
}
